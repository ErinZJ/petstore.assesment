...
export const Header = () => {
  return (
    <div
      className="items-center flex flex-col p-4 "
      style={{
        background:
    ...
    >
      <div className="flex justify-center">
        <img src={animalLogo1} alt="Animal Logo" className="h-16 w-16 mb-4" />
        <img src={animalLogo2} alt="Animal Logo" className="h-16 w-16 mb-4" />
        <img src={animalShelter} alt="Animal Logo" className="h-16 w-16 mb-4" />
      </div>
